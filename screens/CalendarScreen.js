...
export default function CalendarScreen() {
  ...
  const scheduleForDay =
    selectedDate === 10 && month === 5 && year === 2025
      ? CLASS_SCHEDULE
      : [];
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={{paddingBottom: 24}}>
      ...
      <View style={styles.header}>
        ...
        <MaterialCommunityIcons name="bell-outline" size={23} color="#686868" style={styles.bellIcon} />
      </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.monthRow}>
          ...
          <TouchableOpacity onPress={nextMonth} style={styles.arrowBtn}>
            <MaterialCommunityIcons name="chevron-right" size={26} color="#222" />
          </TouchableOpacity>
        </View>
        ...
        {scheduleForDay.length === 0 ? (
          ...
          scheduleForDay.map((cls, idx) => (
            <View key={idx} style={styles.classRow}>
              ...
              <View style={[styles.classTypePill, {backgroundColor: cls.typeColor}]}>
                <Text style={[styles.classTypeText, {color: cls.typeTextColor}]}>{cls.type}</Text>
              </View>
            </View>
          ))
        )}
      ...
      <View style={styles.holidaysCard}>
        <TouchableOpacity style={styles.holidaysHeader} onPress={() => setHolidaysExpanded(h => !h)}>
