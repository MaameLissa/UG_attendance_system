    ...
    <View style={styles.weekCard}>
      ...
      <View style={styles.statusBox}>
        ...
        <View style={styles.barBackground}>
          <View style={[styles.barFill, { width: `${attendancePercent * 100}%` }]} />
        </View>
        ...
        {courses.map((course, idx) => (
          ...
          >
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 6 }}>
              <Text style={[styles.coursePercent, { color: getTextColor(course.percent) }]}>
                {course.percent}%
              </Text>
  ...
  return (
    <View style={styles.quickActionsCard}>
      ...
      <View style={styles.quickActionsRow}>
        <TouchableOpacity style={[styles.quickActionBox, { backgroundColor: '#377cfb' }]} activeOpacity={0.9}>
          <MaterialCommunityIcons name="clipboard-list-outline" size={28} color="#fff" style={styles.quickActionIcon} />
          <Text style={styles.quickActionText}>My{"\n"}Eligibility</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.quickActionBox, { backgroundColor: '#a259e4' }]} activeOpacity={0.9}>
          <MaterialCommunityIcons name="clock-outline" size={28} color="#fff" style={styles.quickActionIcon} />
          <Text style={styles.quickActionText}>Recent{"\n"}Absences</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.quickActionBox, { backgroundColor: '#21a06a' }]} activeOpacity={0.9}>
          <MaterialCommunityIcons name="message-text-outline" size={28} color="#fff" style={styles.quickActionIcon} />
          <Text style={styles.quickActionText}>Ask a{"\n"}Lecturer</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.warningCard}>
        <MaterialCommunityIcons name="alert-circle-outline" size={32} color="#ffc107" style={styles.warningIcon} />
        <View style={{ flex: 1 }}>
          <Text style={styles.warningTitle}>Warning!</Text>
          <Text style={styles.warningText}>
            You're 2 absences away from falling below 75% in DCIT315. Stay Consistent!
          </Text>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 32 }}>
        <View style={styles.container}>
          ...
          <View style={styles.headerRow}>
            ...
            <Icon name="bell" size={22} color="#888" style={[styles.icon, { marginLeft: 10 }]} />
          </View>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.cardSubtitle}>
              Track attendance with fingerprint or facial recognition. Stay exam eligible by meeting UG's 75% rule.
            </Text>
